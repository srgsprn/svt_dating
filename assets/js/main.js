...
(function () {
  ...
  var TRANSLATIONS = {
    ...
    en: {
      ...
      b3_text: 'You get all the info you\'d want about candidates in your dashboard.',
      ...
      s1_text: 'You provide whatever you\'re comfortable sharing. The more detailed and interesting, the easier for our SVT agent to build dialogues with potential candidates.',
      s2_title: 'Set tasks for your SVT agent',
      s2_text: 'Describe your ideal candidate in detail: age, build, height, financial and family situation, hobbies, etc. Our SVT agent analyzes photos, dialogue style, interests; can run psychological and sociotype tests.',
